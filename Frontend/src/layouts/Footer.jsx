      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            ...
            <p className='text-xl'>
              Your one-stop destination for groceries, fashion, sports gear,
            smart gadgets, and home essentials.
            </p>
          </div>
          {/* <!-- Products section --> */}
          <div className="cursor-pointer">
            <h6
              className="mb-4 flex justify-center font-bold uppercase md:justify-start text-xl cursor-pointer hover:underline-offset-1 hover:underline ">
              Products
            </h6>
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200"
