    ...
    <div className="store-bg store-animate-entrance min-h-screen">
      ...
      <div className="relative h-72 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(3,3,4,0.95) 0%, rgba(3,3,4,0.6) 60%, rgba(15,10,0,0.4) 100%)",
          }}
        />
        <div className="absolute inset-0 store-grid-bg opacity-30" />
        {/* Gold glow */}
        <div
          className="absolute left-1/2 top-0 w-80 h-60 rounded-full opacity-10 -translate-x-1/2"
          style={{ background: "#FFD600", filter: "blur(80px)" }}
        />
      ...
      >
        <div className="flex flex-wrap items-center gap-4 max-w-7xl mx-auto">
          <Sparkles size={15} style={{ color: "#FFD600" }} />
          <span
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-12">
        {filteredProducts.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-32 rounded-2xl"
            ...
            <Users size={48} style={{ color: "rgba(255,214,0,0.3)" }} />
