...
const TeamSportsSection = () => {
  const { filteredProducts, sort, setSort, minPrice, setMinPrice, maxPrice, setMaxPrice, handleAddToCart } = useProducts("teamSports");

  return (
    <div className="bh-bg bh-animate-entrance min-h-screen">
      {/* ── HERO ── */}
      <div className="relative h-64 overflow-hidden bh-section-divider">
        <img src="https://images.unsplash.com/photo-1552667466-07770ae110d0?w=1600" alt="Team Sports" className="absolute inset-0 w-full h-full object-cover grayscale" />
        ...
        <div className="absolute bottom-6 right-6 w-6 h-6 bg-white opacity-60" />
        ...
        <div className="absolute inset-0 flex items-center px-8 md:px-16">
          <div className="space-y-3 text-white">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.25em]">Team Sports</span>
            </div>
            <h1 className="bh-section-title text-4xl md:text-6xl text-white">
              Play as<br /><span style={{ color: "#F0C020" }}>One</span>
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-12">
        {filteredProducts.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-32" style={{ background: "white", border: "4px solid #121212", boxShadow: "8px 8px 0px 0px #121212" }}>
            <Trophy size={48} style={{ color: "#1040C0", opacity: 0.3 }} />
...
export default TeamSportsSection;
