  ...
  return (
    <div className="min-h-screen industrial-bg">
      <main className="max-w-7xl mx-auto py-6 sm:py-8 md:py-10 px-4 sm:px-6 space-y-8 sm:space-y-10 md:space-y-12 animate-entrance">
        ...
        {/* ─── Hero Banner — Audio Waveform Theme ───── */}
        <div
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 h-12 sm:h-16 flex items-end justify-center gap-[3px] px-4 sm:px-8 pb-3 sm:pb-4 opacity-30">
            {[...Array(30)].map((_, i) => (
              <div
                key={i}
                ...
                style={{
                  width: '2px',
                  height: `${6 + Math.sin(i * 0.5) * 16 + (i % 7) * 1.5}px`,
