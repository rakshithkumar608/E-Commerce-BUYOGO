...
const Login = () => {
  ...
  return (
    <>
      {/* Inline styles for this page - Minimalist Modern Design System */}
      <style>{`
      ...
      >
        ...
        >
          ...
          >
            {/* Subtle gradient overlay on hover effect */}
            <div 
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              >
                ...
                />
                <div 
                  className="relative w-28 sm:w-32 p-4 rounded-2xl"
                  style={{
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="text-right">
                <span
                  className="text-xs font-medium cursor-pointer transition-all duration-200 inline-block"
                  style={{ 
                    color: '#0052FF',
                    fontFamily: "'Inter', sans-serif",
                  }}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full h-14 rounded-xl font-semibold flex items-center justify-center gap-2.5 transition-all duration-200 group relative overflow-hidden"
                style={{
                  background: loading 
          ...
          {/* Decorative accent block - signature element */}
          <div
            className="absolute -bottom-4 -right-4 w-20 h-20 rounded-2xl pointer-events-none hidden sm:block"
            style={{
